...
const NewPlace = () => {
    ...
    return (
        <form className="place-form" onSubmit={ placeSubmitHandler }>
            ...
            <Input id="description" element="textarea" label="Description" validators={[VALIDATOR_REQUIRE(), VALIDATOR_MINLENGTH(5)]} errorText="Please enter a valid desc" onInput={ inputHandler } />
